#ifndef YEALINK_RTC_YEALINK_VOICE_ENGINE_H_
#define YEALINK_RTC_YEALINK_VOICE_ENGINE_H_
...
class AudioMixer;
class AudioSource;
class YealinkVoiceMediaChannel;

// YealinkVoiceEngine is a class to be used with CompositeMediaEngine.
// It uses the WebRtc VoiceEngine library for audio handling.
class YealinkVoiceEngine final : public VoiceEngineInterface {
  friend class YealinkVoiceMediaChannel;
 ...
 public:
  ...
  // May only be called by YealinkVoiceMediaChannel.
  void RegisterChannel(YealinkVoiceMediaChannel* channel);
  void UnregisterChannel(YealinkVoiceMediaChannel* channel);
 ...
 private:
  ...
  std::vector<YealinkVoiceMediaChannel*> channels_;
  ...
  RTC_DISALLOW_IMPLICIT_CONSTRUCTORS(YealinkVoiceEngine);
};

// YealinkVoiceMediaChannel is an implementation of VoiceMediaChannel that uses
// WebRtc Voice Engine.
class YealinkVoiceMediaChannel final : public VoiceMediaChannel,
                                      public webrtc::Transport {
 public:
  YealinkVoiceMediaChannel(YealinkVoiceEngine* engine,
                          const MediaConfig& config,
                          const AudioOptions& options,
                          const webrtc::CryptoOptions& crypto_options,
                          webrtc::Call* call);
  ~YealinkVoiceMediaChannel() override;
 ...
 private:
  ...
  YealinkVoiceEngine* engine() { return engine_; }
  ...
  YealinkVoiceEngine* const engine_ = nullptr;
  std::vector<AudioCodec> send_codecs_;
  ...
  RTC_DISALLOW_IMPLICIT_CONSTRUCTORS(YealinkVoiceMediaChannel);
};
}  // namespace cricket

#endif  // YEALINK_RTC_YEALINK_VOICE_ENGINE_H_
