...
YealinkVideoChannel::WebRtcVideoSendStream::ConfigureVideoEncoderSettings(
...
YealinkUnsignalledSsrcHandler::GetDefaultSink() const {
  return default_sink_;
}

void YealinkUnsignalledSsrcHandler::SetDefaultSink(
...
VideoMediaChannel* YealinkVideoEngine::CreateMediaChannel(
    webrtc::Call* call,
...
RtpCapabilities YealinkVideoEngine::GetCapabilities() const {
...
absl::optional<YealinkVideoChannel::VideoCodecSettings>
YealinkVideoChannel::SelectSendVideoCodec(
...
bool YealinkVideoChannel::NonFlexfecReceiveCodecsHaveChanged(
  ...
  // YealinkVideoChannel::GetChangedRecvParameters, so disregard FlexFEC in the
  // comparison here.
  return !absl::c_equal(before, after,
                        VideoCodecSettings::EqualsDisregardingFlexfec);
}

bool YealinkVideoChannel::GetChangedSendParameters(
...
rtc::DiffServCodePoint YealinkVideoChannel::PreferredDscp() const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  return preferred_dscp_;
}

bool YealinkVideoChannel::SetSendParameters(const VideoSendParameters& params) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::SetSendParameters");
  ...
  if (changed_params.codec || changed_params.max_bandwidth_bps) {
    ...
    if (params.max_bandwidth_bps >= 0) {
      ...
      // YealinkVideoChannel (in which case we're good), or per sender (SSRC),
...
webrtc::RtpParameters YealinkVideoChannel::GetRtpSendParameters(
    uint32_t ssrc) const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
webrtc::RTCError YealinkVideoChannel::SetRtpSendParameters(
    uint32_t ssrc,
    const webrtc::RtpParameters& parameters) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::SetRtpSendParameters");
  auto it = send_streams_.find(ssrc);
  if (it == send_streams_.end()) {
...
webrtc::RtpParameters YealinkVideoChannel::GetRtpReceiveParameters(
    uint32_t ssrc) const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
bool YealinkVideoChannel::SetRtpReceiveParameters(
    uint32_t ssrc,
    const webrtc::RtpParameters& parameters) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::SetRtpReceiveParameters");
...
bool YealinkVideoChannel::GetChangedRecvParameters(
...
bool YealinkVideoChannel::SetRecvParameters(const VideoRecvParameters& params) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::SetRecvParameters");
...
std::string YealinkVideoChannel::CodecSettingsVectorToString(
...
bool YealinkVideoChannel::GetSendCodec(VideoCodec* codec) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  if (!send_codec_) {
...
bool YealinkVideoChannel::SetSend(bool send) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::SetSend");
...
bool YealinkVideoChannel::SetVideoSend(
    uint32_t ssrc,
    const VideoOptions* options,
...
bool YealinkVideoChannel::ValidateSendSsrcAvailability(
...
bool YealinkVideoChannel::ValidateReceiveSsrcAvailability(
    const StreamParams& sp) const {
  for (uint32_t ssrc : sp.ssrcs) {
...
bool YealinkVideoChannel::AddSendStream(const StreamParams& sp) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
bool YealinkVideoChannel::RemoveSendStream(uint32_t ssrc) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
void YealinkVideoChannel::DeleteReceiveStream(
    YealinkVideoChannel::WebRtcVideoReceiveStream* stream) {
...
void YealinkVideoChannel::ConfigureReceiverRtp(
...
bool YealinkVideoChannel::RemoveRecvStream(uint32_t ssrc) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
bool YealinkVideoChannel::SetSink(
    uint32_t ssrc,
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
bool YealinkVideoChannel::GetStats(VideoMediaInfo* info) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  TRACE_EVENT0("webrtc", "YealinkVideoChannel::GetStats");
...
void YealinkVideoChannel::FillBitrateInfo(BandwidthEstimationInfo* bwe_info) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
void YealinkVideoChannel::FillSendAndReceiveCodecStats(
...
void YealinkVideoChannel::OnPacketReceived(rtc::CopyOnWriteBuffer* packet,
  ...
  switch (unsignalled_ssrc_handler_->OnUnsignalledSsrc(this, ssrc)) {
    case UnsignalledSsrcHandlerInternal::kDropPacket:
      return;
    case UnsignalledSsrcHandlerInternal::kDeliverPacket:
      break;
  }
...
void YealinkVideoChannel::OnReadyToSend(bool ready) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
void YealinkVideoChannel::OnNetworkRouteChanged(
...
void YealinkVideoChannel::SetInterface(
...
void YealinkVideoChannel::SetFrameDecryptor(
    uint32_t ssrc,
...
void YealinkVideoChannel::SetFrameEncryptor(
    uint32_t ssrc,
...
absl::optional<int> YealinkVideoChannel::GetBaseMinimumPlayoutDelayMs(
    uint32_t ssrc) const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  // SSRC of 0 represents the default receive stream.
  if (ssrc == 0) {
...
absl::optional<uint32_t> YealinkVideoChannel::GetDefaultReceiveStreamSsrc() {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
std::vector<webrtc::RtpSource> YealinkVideoChannel::GetSources(
    uint32_t ssrc) const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  auto it = receive_streams_.find(ssrc);
  if (it == receive_streams_.end()) {
...
bool YealinkVideoChannel::SendRtcp(const uint8_t* data, size_t len) {
  rtc::CopyOnWriteBuffer packet(data, len, kMaxRtpPacketLen);
  rtc::PacketOptions rtc_options;
  if (DscpEnabled()) {
    rtc_options.dscp = PreferredDscp();
...
YealinkVideoChannel::WebRtcVideoSendStream::VideoSendStreamParameters::
...
YealinkVideoChannel::WebRtcVideoSendStream::WebRtcVideoSendStream(
    webrtc::Call* call,
...
YealinkVideoChannel::WebRtcVideoSendStream::GetDegradationPreference() const {
...
YealinkVideoChannel::WebRtcVideoSendStream::GetSsrcs() const {
  return ssrcs_;
}

void YealinkVideoChannel::WebRtcVideoSendStream::SetCodec(
...
void YealinkVideoChannel::WebRtcVideoSendStream::SetSendParameters(
...
webrtc::RTCError YealinkVideoChannel::WebRtcVideoSendStream::SetRtpParameters(
  ...
  rtp_parameters_ = new_parameters;
  // Codecs are currently handled at the YealinkVideoChannel level.
...
YealinkVideoChannel::WebRtcVideoSendStream::GetRtpParameters() const {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  return rtp_parameters_;
}

void YealinkVideoChannel::WebRtcVideoSendStream::SetFrameEncryptor(
    rtc::scoped_refptr<webrtc::FrameEncryptorInterface> frame_encryptor) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
void YealinkVideoChannel::WebRtcVideoSendStream::UpdateSendState() {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  if (sending_) {
...
YealinkVideoChannel::WebRtcVideoSendStream::CreateVideoEncoderConfig(
  ...
  // YealinkVideoChannel::SetSendParameters, this value does not override the
...
void YealinkVideoChannel::WebRtcVideoSendStream::ReconfigureEncoder() {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  if (!stream_) {
...
void YealinkVideoChannel::WebRtcVideoSendStream::SetSend(bool send) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  sending_ = send;
  UpdateSendState();
}

void YealinkVideoChannel::WebRtcVideoSendStream::RemoveSink(
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink) {
  RTC_DCHECK_RUN_ON(&thread_checker_);
...
void YealinkVideoChannel::WebRtcVideoSendStream::AddOrUpdateSink(
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink,
...
VideoSenderInfo YealinkVideoChannel::WebRtcVideoSendStream::GetVideoSenderInfo(
    bool log_stats) {
...
void YealinkVideoChannel::WebRtcVideoSendStream::FillBitrateInfo(
...
void YealinkVideoChannel::WebRtcVideoSendStream::RecreateWebRtcStream() {
  RTC_DCHECK_RUN_ON(&thread_checker_);
  if (stream_ != NULL) {
    call_->DestroyVideoSendStream(stream_);
  }
...
const std::vector<uint32_t>&
YealinkVideoChannel::WebRtcVideoReceiveStream::GetSsrcs() const {
  return stream_params_.ssrcs;
}

std::vector<webrtc::RtpSource>
YealinkVideoChannel::WebRtcVideoReceiveStream::GetSources() {
  RTC_DCHECK(stream_);
  return stream_->GetSources();
}

webrtc::RtpParameters
YealinkVideoChannel::WebRtcVideoReceiveStream::GetRtpParameters() const {
...
void YealinkVideoChannel::WebRtcVideoReceiveStream::SetLocalSsrc(
    uint32_t local_ssrc) {
...
void YealinkVideoChannel::WebRtcVideoReceiveStream::SetFeedbackParameters(
    bool nack_enabled,
    bool remb_enabled,
...
void YealinkVideoChannel::WebRtcVideoReceiveStream::SetRecvParameters(
...
void YealinkVideoChannel::WebRtcVideoReceiveStream::OnFrame(
...
bool YealinkVideoChannel::WebRtcVideoReceiveStream::IsDefaultStream() const {
  return default_stream_;
}

void YealinkVideoChannel::WebRtcVideoReceiveStream::SetFrameDecryptor(
    rtc::scoped_refptr<webrtc::FrameDecryptorInterface> frame_decryptor) {
...
void YealinkVideoChannel::WebRtcVideoReceiveStream::SetSink(
    rtc::VideoSinkInterface<webrtc::VideoFrame>* sink) {
  rtc::CritScope crit(&sink_lock_);
  sink_ = sink;
}
...
std::string
YealinkVideoChannel::WebRtcVideoReceiveStream::GetCodecNameFromPayloadType(
    int payload_type) {
...
VideoReceiverInfo
YealinkVideoChannel::WebRtcVideoReceiveStream::GetVideoReceiverInfo(
    bool log_stats) {
...
YealinkVideoChannel::VideoCodecSettings::VideoCodecSettings()
    : flexfec_payload_type(-1), rtx_payload_type(-1) {}

bool YealinkVideoChannel::VideoCodecSettings::operator==(
    const YealinkVideoChannel::VideoCodecSettings& other) const {
  return codec == other.codec && ulpfec == other.ulpfec &&
         flexfec_payload_type == other.flexfec_payload_type &&
         rtx_payload_type == other.rtx_payload_type;
}

bool YealinkVideoChannel::VideoCodecSettings::EqualsDisregardingFlexfec(
    const YealinkVideoChannel::VideoCodecSettings& a,
    const YealinkVideoChannel::VideoCodecSettings& b) {
...
std::vector<YealinkVideoChannel::VideoCodecSettings>
YealinkVideoChannel::MapCodecs(const std::vector<VideoCodec>& codecs) {
