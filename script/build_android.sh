...
gn gen out/x86 --args="import(\"//yealink/build/args/android.gni\") target_cpu=\"x86\" is_debug=false"
gn gen out/x86_debug --args="import(\"//yealink/build/args/android.gni\") target_cpu=\"x86\" is_debug=true"

gn gen out/x64 --args="import(\"//yealink/build/args/android.gni\") target_cpu=\"x64\" is_debug=false"
gn gen out/x64_debug --args="import(\"//yealink/build/args/android.gni\") target_cpu=\"x64\" is_debug=true"
